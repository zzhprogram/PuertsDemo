...
// __TYPE_DECL_END
// __TYPE_DECL_START: 8D0F485244D384D0E56A3BAB58993393
    namespace Game.UMGTest.UMG_Panel {
        class UMG_Panel_C extends UE.UserWidget {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            Button_ChangeLevel: UE.Button;
            Button_Click_WihtOutNested: UE.Button;
            Button_Click_WithNested: UE.Button;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): UMG_Panel_C;
            static Load(InName: string): UMG_Panel_C;
        
            __tid_UMG_Panel_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 642450154A8C5841E83B089A14F8B9CF
    namespace Game.UMGTest.UMG_Main {
        class UMG_Main_C extends UE.UserWidget {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UMG_Child: UE.Game.UMGTest.UMG_Child.UMG_Child_C;
            static StaticClass(): Class;
...
// __TYPE_DECL_END
// __TYPE_DECL_START: 9E58933644FA728A7E04C6A9DB2E931C
    namespace Game.UMGTest.UMG_Child {
        class UMG_Child_C extends UE.UserWidget {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): UMG_Child_C;
            static Load(InName: string): UMG_Child_C;
        
            __tid_UMG_Child_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 0D820BD740AD95B938720DBEDE4AA7F6
    namespace Game.UMGTest.UMG_Alone {
        class UMG_Alone_C extends UE.UserWidget {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): UMG_Alone_C;
            static Load(InName: string): UMG_Alone_C;
        
            __tid_UMG_Alone_C_0__: boolean;
        }

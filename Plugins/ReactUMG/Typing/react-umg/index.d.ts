declare module "react-umg" {
    ...
    class SoundEffectPresetUserWidget extends React.Component<SoundEffectPresetUserWidgetProps> {
        nativePtr: UE.SoundEffectPresetUserWidget;
    }
    ...
    interface UMG_Panel_CProps extends UserWidgetProps {
    }

    class UMG_Panel_C extends React.Component<UMG_Panel_CProps> {
        nativePtr: UE.Game.UMGTest.UMG_Panel.UMG_Panel_C;
    }

    interface UMG_Child_CProps extends UserWidgetProps {
    }

    class UMG_Child_C extends React.Component<UMG_Child_CProps> {
        nativePtr: UE.Game.UMGTest.UMG_Child.UMG_Child_C;
    }

    interface UMG_Main_CProps extends UserWidgetProps {
    }

    class UMG_Main_C extends React.Component<UMG_Main_CProps> {
        nativePtr: UE.Game.UMGTest.UMG_Main.UMG_Main_C;
    }

    interface UMG_Alone_CProps extends UserWidgetProps {
    }

    class UMG_Alone_C extends React.Component<UMG_Alone_CProps> {
        nativePtr: UE.Game.UMGTest.UMG_Alone.UMG_Alone_C;
    }
